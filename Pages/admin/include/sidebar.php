...
<aside id="fes-dashboard-sidebar" class="fixed inset-y-0 left-0 z-40 w-72 flex flex-col bg-fes-dark text-white -translate-x-full transition-transform duration-200 ease-out md:translate-x-0 md:flex">
    ...
    <nav class="flex-1 px-4 py-4">
        ...
        <a href="equipment.php" class="mt-1 flex items-center gap-3 px-4 py-3 rounded-lg <?php echo ($current_page === 'equipment' || $current_page === 'add_equipment') ? 'bg-fes-red shadow-md shadow-black/10 font-medium' : 'text-white/80 hover:text-white hover:bg-white/5'; ?> transition">
        ...
        <a href="maintenance.php" class="mt-1 flex items-center gap-3 px-4 py-3 rounded-lg <?php echo $is_maintenance ? 'bg-fes-red shadow-md shadow-black/10 font-medium' : 'text-white/80 hover:text-white hover:bg-white/5'; ?> transition">
